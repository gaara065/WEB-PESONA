        ...
        <div class="dez-bnr-inr overlay-black-middle" style="background-image:url(images/banner/bnr2.jpg);">
            <div class="container">
                <div class="dez-bnr-inr-entry">
                    <h1 class="text-white">PENILAIAN, KRITIK, SARAN, PENGADUAN KLINIK  PESONA BUNDA </h1>
                </div>
            </div>
        </div>
        ...
        <div class="section-full content-inner">
            ...
            <div class="container">
                ...
                <div class="section-head text-center ">
                    <h3 class="h3 text-uppercase">PENILAIAN, KRITIK, SARAN, KEPUASAN   <span class="text-primary">PASIEN</span></h3>
                          </div>
